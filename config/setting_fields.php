    ...
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'class' => '', // any class for input
                'value' => 'Built with ♥ from <a href="https://Pitomec.design" target="_blank">Pitomec DESIGN.</a>', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'UI Powered By <a href="https://hopeui.Pitomec.design/" target="_blank">HOPE UI</a>', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
                ...
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'admin@Porosenocheck.com', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
    ...
    'mail' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Porosenocheck', // default value if you wantPassword
            ],
        ],
