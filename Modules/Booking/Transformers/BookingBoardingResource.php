...
class BookingBoardingResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'dropoff_date_time' => optional($this->boarding)->dropoff_date_time,
            'dropoff_address' => optional($this->boarding)->dropoff_address,
            'pickup_date_time' => optional($this->boarding)->pickup_date_time,
            'pickup_address' => optional($this->boarding)->pickup_address,
            'additional_facility' => json_decode(optional($this->boarding)->additional_facility),
