...
* --------------------------------------------------------------------
*/
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['web', 'auth','permission:view_category']], function () {
    /*
    ...
    */
    ...
    Route::group(['prefix' => 'categories', 'as' => 'categories.'], function () {
        ...
        // Route::patch("trashed/{id}", [CategoriesController::class, 'restore'])->name("restore");
    });
